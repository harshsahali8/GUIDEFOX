...
const names: Name[] = [
  {
    course: 'HTML, CSS, JS',
    imageSrc: '/mentors/assets/courses/coursesOne.svg',
  ...
  {
    course: 'Node.js',
    imageSrc: '/mentors/assets/courses/coursesTwo.svg',
  ...
  {
    course: 'Database',
    imageSrc: '/mentors/assets/courses/coursesThree.svg',
  ...
  {
    course: 'React.js',
    imageSrc: '/mentors/assets/courses/coursesFour.svg',
      ...
      <div className=" text-lg sm:text-sm py-5 lg:py-0">
        ...
        <div className="flex justify-between border-solid border-2 border-grey500 rounded-md p-2">
          ...
          <div className="flex flex-row space-x-4">
            <div className="flex">
              <img src={'/mentors/assets/courses/account.svg'} alt="circle" />
              <p className="text-lightgrey ml-1">120</p>
            </div>
            <div className="flex">
              <img src={'/mentors/assets/courses/Star.svg'} alt="star" />
